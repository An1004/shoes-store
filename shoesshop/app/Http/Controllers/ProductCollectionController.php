...
class ProductCollectionController extends Controller
{
    public function Index(){
        ...
        if (Session::get('admin_role')==3) {
            ...
            $all_collection = Collection::orderBy('id', 'DESC')->paginate(10);
    ...
    public function CollectionSave(Request $request){
        ...
        if(Session::get('admin_role')==3){
            ...
            if ($get_collection) {
                ...
                $path = '/uploads/admin/collection';
                //them hinh anh
                if ($collection->dongsanpham_anh==$get_image) {
                    if($path.$get_image){
                        ...
                        $get_image->move('uploads/admin/collection', $new_image);
