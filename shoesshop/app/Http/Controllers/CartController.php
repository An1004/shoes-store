...
class CartController extends Controller
{
    ...
    public function AddToCart(Request $request){
        ...
        if($data['product_quantity'] > $pro_in_stock->sanphamtonkho_so_luong_ton){
            ...
            if($cart) {
                ...
                foreach($cart as $key => $value){
                        if($value['product_size_id']==$data['product_size_id'] && $value['product_id']==$data['product_id']){
                            ...
                            if($cart[$key]['product_quantiy'] > $pro_in_stock->sanphamtonkho_so_luong_ton)
                                {
                                    $cart[$key]['product_quantiy'] = $pro_in_stock->sanphamtonkho_so_luong_ton;
                                }
                             $is_ava++;
                        }
                    }
