    ...
    public function ShowCommentDetail($comment_id){
        ...
        // }else{
            ...
            if (!$comment) {
                ...
                $get_customer_img = Customer::where('id',$comment->khachhang_id)->first();
             
                return view('admin.pages.comment.show_comment_detail')->with(compact('comment_reply', 'comment','get_customer_img'));
            }
        // }
    }
            ...
            if (!$request) {
                ...
                if ($data['reply_admin_comment']==null) {
                    ...
                    if (isset($data['reply_customer_id'])) {
                        $comment=new Comment();
                        $comment->binhluan_ten_nguoi_danh_gia='Admin SHOES';
