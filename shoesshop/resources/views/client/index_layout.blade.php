...
<html class="no-js" lang="zxx">
    <head>
        ...
        <link href="{{URL::asset('/frontend/css/sweetalert.css')}}" rel="stylesheet">
...
<!-- <script>
  ...
  paypal.Button.render({
    ...
    env: 'sandbox',
    client: {
      sandbox: 'AXZTavxf-POCCcloeA6QzCavOix1iExZOvJ8b06-h7GVqU5tL3xQMIdV8I-WGmC7nKAI-aOqc8F8wNGw',
...
<script>
    ...
    //   click_to_voice.addEventListener('click',function(){
    //         var speech = true;
    ...
    //             document.querySelector('#keywork').value= transcript
...
<script type="text/javascript">
        function ClickImage(value,id){
            ...
            $.ajax({
                url:"{{url('/get-product-image')}}",
                method: 'GET',
                data:{id:id},
                success:function(data){
                // $('#price').html(data);
                $('#change_image').html(data);
...
<script type="text/javascript">
    function showSize(value,id){
        var value = value;
        var id = id;
        $.ajax({
            url:"{{url('/change-price')}}",
            method: 'GET',
            data:{size_id:value,product_id:id},
            success:function(data){
                // $('#price').html(data);
                $('.price_change').html(data);
                
            }
            
        });
        $.ajax({
            url:"{{url('/change-price-hidden')}}",
            method: 'GET',
            data:{size_id:value,product_id:id},
            success:function(data){
                $('#price').html(data);
        ...
        $.ajax({
            url:"{{url('/change-instock-product')}}",
            method: 'GET',
            data:{size_id:value,product_id:id},
            success:function(data){
                $('.product_stock').html(data);
                // $('.price_change').html(data);
...
<script type="text/javascript">
    function changeFeeship(value){
        $.ajax({
            url:"{{url('/change-feeships')}}",
            method: 'GET',
            data:{address_name:value},
            success:function(data){
                // $('#price').html(data);
        ...
        $.ajax({
            url:"{{url('/change-feeship1')}}",
            method: 'GET',
            data:{address_name:value},
            success:function(data){
                // $('#price').html(data);
                $('.changefeeship').html(data);
                
            }
            
        });
        // $('#changeaddresshidden').html('<input name="order_checkout_address" value="'.value.'" required="" type="number">');
    }
