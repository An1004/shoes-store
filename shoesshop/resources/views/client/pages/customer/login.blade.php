            ...
            <div class="col-lg-6 col-md-6">
                <div class="account_form">
                    ...
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form action="{{ URL::to('/check-login-customer')}}" method="POST" style="border-color: black">
                        @csrf
                        <p>
                        ...
                        <br>
                        <button style="border-color: #FA7070 ; font-weight:bold; background:white">
                            <a href="{{ URL::to('/login-google') }}">
                               
                                Đăng nhập bằng <img src="{{asset('/uploads/client/customer/unnamed.png')}}" alt="" width="20px" >
                            </a>
                        </button>
                    </form>
                 </div>
