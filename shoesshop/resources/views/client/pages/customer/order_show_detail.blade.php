                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif ($customer_order->dondathang_tinh_trang_thanh_toan==4)
                                                Đơn hàng đã bị hủy - đã thanh toán PayPal
                                        ...
                                        <td>
                                            ...
                                            @elseif($customer_order->dondathang_tinh_trang_thanh_toan==4 && $customer_order->dondathang_trang_thai==0)
                                                Đã xác nhận - đã thanh toán PayPal - Chưa vận chuyển
                                    ...
                                    @if($all_order_detail==true)
                                        @foreach ($all_order_detail as $key =>$product)
                                            <tr>
                                                ...
                                                <td>{{ $product->chitietdondathang_don_gia}}</td>
