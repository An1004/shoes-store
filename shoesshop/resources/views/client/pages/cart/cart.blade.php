            ...
            <div class="col-12">
                <div class="table_cart">
                                ...
                                @if(Session::get('cart')==true)
                                    ...
                                    @foreach (Session::get('cart') as $key =>$product)
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_thumb"><a href="#"><img src="{{asset('/uploads/admin/product/'.$product['product_img'])}}" width="70px" height="75px" alt=""></a></td>
                    ...
                    <div class="cart_submit">
                        ...
                        <button type="submit" class="btn mr-2">Cập Nhật Giỏ Hàng</button>
                        @endif
                    </div>
                </div>
             </div>
