                ...
                <div class="sidebar_widget wishlist mb-30">
                    ...
                    @foreach ($all_product_viewed as $key=>$product_viewed)
                        @if ($count_re<=3)
                            <div class="cart_item">
                                <div class="cart_img">
                                    <a href="{{URL::to('/product-detail/'.$product_viewed->id)}}"><img src="{{asset('/uploads/admin/product/'.$product_viewed->sanpham_anh)}}" width="70px" height="75px" alt=""></a>
                                </div>
                                <div class="cart_info">
                    ...
                    @else
                        <div class="special_product_inner mb-20">
                            <div class="special_p_thumb">
                                <a href="{{URL::to('/product-detail/'.$pro_rating->id)}}"><img src="{{asset('/uploads/admin/product/'.$pro_rating->sanpham_anh)}}" class="pro-img-rating" width="60px" height="80px" alt=""></a>
                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single_product">
                                            <div class="product_thumb">
                                               <a href="{{URL::to('/product-discount-detail/'.$product->id)}}"><img id="wishlist_viewed_product_image{{ $product->id }}" src="{{asset('/uploads/admin/product/'.$product->sanpham_anh)}}" alt=""></a>
                                               <div class="hot_img">
                                            ...
                                            <div class="product_info">
                                                <ul>
                                                    ...
                                                    <li><a class="views-product-detail" data-views_product_id="{{$product->id}}" id="wishlist_viewed_product_url{{ $product->id }}"  href="{{URL::to('/product-discount-detail/'.$product->id)}}"  title="Quick view">Chi tiết</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
