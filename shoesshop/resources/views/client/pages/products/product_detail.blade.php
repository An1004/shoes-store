    ...
    <div class="row">
                ...
                <div class="product_tab product_video fix">
                    <div class="tab-content produc_tab_c">
                        <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                            <div class="modal_img">
                                <a href="#" id="change_image"><img id="wishlist_viewed_product_image{{ $product->id }}" src="{{asset('/uploads/admin/product/'.$product->sanpham_anh)}}" width="380px" height="400px" alt=""></a>
                                <div class="img_icone">
                                   <img src="{{asset('/frontend/img/cart/span-new.png')}}" alt="">
                               </div>
                                <div class="view_img">
                                    <a class="large_view" href="{{asset('/uploads/admin/product/'.$product->sanpham_anh)}}"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        @foreach ($all_product_image as $key =>$pro_img)
                            <div class="tab-pane fade" id="p_tab2" role="tabpanel">
                                <div class="modal_img">
                                    <a href="#"><img src="{{asset('/uploads/admin/productimages/'.$pro_img->anhsanpham_ten)}}" alt=""></a>
                                    <div class="img_icone">
                                    <img src="{{asset('/frontend/img/cart/span-new.png')}}" alt="">
                                </div>
                                    <div class="view_img">
                                        <a class="large_view" href="{{asset('/uploads/admin/productimages/'.$pro_img->anhsanpham_ten)}}"><i class="fa fa-search-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="product_tab_button" >
                        <ul class="nav" role="tablist">
                            ...
                            @foreach ($all_product_image as $key =>$pro_img)
                                @if ($count_img<=3)
                                    <li onclick="ClickImage('{{$pro_img->id}}')">
                                        <a class="active" data-toggle="tab" href="#p_tab2" role="tab" aria-controls="p_tab1" aria-selected="false" ><img src="{{asset('/uploads/admin/productimages/'.$pro_img->anhsanpham_ten)}}" width="90px" height="120px" alt="" ></a>
                                    </li>
                                    @php
                                        $count_img++;
                                    @endphp
                    ...
                    {{--  <div class="product_tab_button ">
                        <ul id="imageGallery">
                            <li data-thumb="{{asset('/uploads/admin/product/'.$product->sanpham_anh)}}" data-src="{{asset('/uploads/admin/product/'.$product->sanpham_anh)}}">
                              <img class="product-img" src="{{asset('/uploads/admin/product/'.$product->sanpham_anh)}}" />
                            </li>
                            @foreach ($all_product_image as $key =>$pro_img)
                                <li data-thumb="{{asset('/uploads/admin/productimages/'.$pro_img->anhsanpham_ten)}}" data-src="{{asset('/uploads/admin/productimages/'.$pro_img->anhsanpham_ten)}}">
                                    <img class="product-img"  src="{{asset('/uploads/admin/productimages/'.$pro_img->anhsanpham_ten)}}" />
                                </li>
                            @endforeach
                        </ul>
                    </div>  --}}
            ...
            <div class="col-lg-8 col-md-6">
                <div class="product_d_right ">
                    ...
                    <div class="content_price mb-15" id = "price">
                        <span>
                    ...
                    <form action="{{ URL::to('/add-cart') }}" method="POST">
                        ...
                        <div class="box_quantity mb-20 ">
                                <h5>Số lượng</h5>
                                <input name="product_quantity" class="product_quantity_{{ $product->id }}" min="1" value="1" 
                                            @php
                                                $qty_in_stock=0;
                                            @endphp
                                ...
                                <input name="product_id" value="{{ $product->id }}" class="product_id_{{ $product->id }}" id="product_name" type="hidden">
                                ...
                                <div class="price_change"> <input name="product_price" class="product_price_{{ $product->id }}" value="{{number_format($product->sanpham_gia_ban ,0,',','') }}" type="hidden"></div>
                        ...
                        <div class="mb-20 col-md-4">
                            ...
                            <select name="product_size_id" class="product_size_id_{{ $product->id }} form-control" id="group_1" onchange="showSize(this.options[this.selectedIndex].value,'{{ $product->id }}')">
                    ...
                    <div class="product_stock mb-20">
                        <p>{{$product_in_stock->sanphamtonkho_so_luong_ton }} sản phẩm</p>
                         <span>
 
                             @if($product_in_stock->sanphamtonkho_so_luong_ton >0)
                             Trong kho
                             @else
                             Bán hết
                             @endif
            ...
            <div class="product_d_inner">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="reviews" role="tabpanel">
                        ...
                        @endif
                        @if(Session::get('customer_id')==true)
                            @if (count($test_order)!=0)
                                @foreach($test_order as $key => $test)
                                    @if($test->khachhang_id==Session::get('customer_id'))
                                    <form action="{{URL::to('/post-comment-customer')}}" method="POST">
                                        ...
                                        <div class="product_review_form rmp">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="rate-error" text-align="center"></div>
                                            </div>
                                ...
                                @foreach ($comment_customer as $key=>$comment )
                                    <div class="product_info_inner ">
                                        <div class="product_ratting mb-10 col-md-6">
                                            @if($comment->khachhang_anh=='')
                                                <div class="col-md-2">
                                                    <img width="100%" src="{{URL::asset('/backend/images/users/batman-icon.png')}}" class="img img-responsive img-thumbnail comment-img">
                                                </div>
                                            @else
                                                <div class="col-md-2">
                                                    <img width="100%" src="{{URL::asset('/uploads/client/customer/'.$comment->khachhang_anh)}}" class="img img-responsive img-thumbnail comment-img">
                                                </div>
                                            @endif
                                            <br>
                                            <div col-md-4>
