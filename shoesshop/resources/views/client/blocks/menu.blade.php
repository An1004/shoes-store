                ...
                <div class="main_menu_inner">
                    <div class="main_menu d-none d-lg-block">
                        <nav>
                            <ul>
                                    ...
                                    <div class="mega_menu">
                                        ...
                                        {{-- <div class="mega_bottom fix">
                                            <div class="mega_thumb">
                                                <a href="#"><img src="{{URL::asset('/frontend/img/banner/banner1.png')}}" alt=""></a>
                                            </div>
                                            <div class="mega_thumb">
                                                <a href="#"><img src="{{URL::asset('/frontend/img/banner/banner2.png')}}" alt=""></a>
                                            </div>
                                        </div> --}}
                                    </div>
                                </li>
                                ...
                                <li>
                                    <a href="{{ URL::to('/my-account')}}" title="My account">Tài Khoản</a>
                                </li>
                                @else
                                <li>
                                    <a href="{{ URL::to('/login-customer')}}" title="My account">Tài Khoản</a>
                                </li>
                                @endif
                                <li>
                    ...
                    <div class="mobile-menu d-lg-none">
                        <nav>
                            <ul>
                                <li>
                                    <a href="{{URL::to ('/')}}"> <h5> TRANG CHỦ</h5></a>
                                </li>
                                <li>
                                    <a href="{{URL::to ('/shop-now')}}"><h5>MUA HÀNG</h5></a>
                                </li>
                                <li><a href=""><h5>DANH MỤC </h5></a></li>
                                    <div>
                                        <li>
