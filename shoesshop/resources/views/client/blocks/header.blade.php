     ...
     <div class="row align-items-center">
        <!--logo start-->
         <div class="col-lg-3 col-md-3">
             <div class="logo">
                 <a href="{{URL::to ('/')}}"><span>SHOES STORE </span><img src="{{asset('/frontend/img/logo/5499252.png')}}" width="30px" height="35px"> </a>
             </div>
         </div>
         <!--logo end-->
         <div class="col-lg-9 col-md-9">
             <div class="header_right_info">
                 <div class="search_bar">
                    {{-- <button id="click_to_voice"><i class="fa fa-microphone"></i></button> --}}
                    <form action="{{URL::to ('/search-product-customer')}}" method="GET">
                        ...
                        @endif
                        name="search_product_customer" type="search" id="keywork">
                     ...
                     <div class="mini_cart">
                        @if(Session::get('cart')==true)
                            ...
                            @endphp
                                <div class="cart_item">
                                    <div class="cart_img">
                                        <a href="#"><img src="{{asset('/uploads/admin/product/'.$product['product_img'])}}" alt=""></a>
                                    </div>
                                    <div class="cart_info">
