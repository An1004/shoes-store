    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                ...
                <a href="{{URL::to('/staff-my-account-change-email/'.session()->get('admin_id'))}}" class="dropdown-item notify-item">
                    <i class="remixicon-lock-line"></i>
                    <span>Đổi email</span>
                </a>
    ...
    <div class="logo-box">
        <a href="{{ URL::to('/dashboard') }}" class="logo text-center">
            <span class="logo-lg">
                    ...
                    <h3><i class='fab fa-staylinked'></i> SHOES ADMIN</h3>
                    <!-- <span class="logo-lg-text-light">SHOES</span> -->
            </span>
            <span class="logo-sm">
