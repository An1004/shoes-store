            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="{{URL::to('/dashboard')}}" class="waves-effect">
                     ...
                     @if (Session::get('quyen_sanpham')==1)
                     <li>
                     ...
                     @endif
                       @if (Session::get('quyen_nhaphang')==1)
                       <li>
                        <a href="javascript: void(0);" class="waves-effect">
                            <i class="remixicon-stack-line"></i>
                       ...
                       @endif
                       @if (Session::get('quyen_donhang')==1)
                       <li>
                    ...
                    @if (Session::get('quyen_giaohang')==1)
                    <li>
                    ...
                    @if (Session::get('quyen_thongke')==1)
                        <li>
                            <a href="javascript: void(0);" class="waves-effect">
                                <i class="remixicon-folder-add-line"></i>
                    ...
                    @endif
                        @if (Session::get('quyen_nhanvien')==1)
                        <li> 
                            <a href="javascript: void(0);" class="waves-effect">
                                <i class="remixicon-stack-line"></i>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li>
                                    ...
                                    <li>
                                        <a href="{{URL::to('/role')}}">Phân quyền</a>
                                    </li>
                                    {{-- <li>
