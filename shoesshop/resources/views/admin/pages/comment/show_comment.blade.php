                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if($comment->binhluan_trang_thai==1)
                                                <input type="button" data-comment_status="0" data-comment_id="{{$comment->id}}" id="{{$comment->sanpham_id}}" class="btn btn-primary btn-xs comment_approval" value="Đã duyệt" >
                                            @else
                                                <input type="button" data-comment_status="1" data-comment_id="{{$comment->id}}" id="{{$comment->sanpham_id}}" class="btn btn-danger btn-xs comment_approval" value="Chưa duyệt" >
                                            @endif
                                        </td>
                                        <td>
