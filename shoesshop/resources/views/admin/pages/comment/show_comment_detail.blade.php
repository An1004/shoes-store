                                ...
                                <div class="col-12">
                                    <div class="p-2">
                                        <div class="row style_comment">
                                            @if($get_customer_img->khachhang_anh=='')
                                                <div class="col-md-2">
                                                    <img width="100%" src="{{URL::asset('/backend/images/users/batman-icon.png')}}" class="img img-responsive img-thumbnail">
                                                </div>
                                            @else
                                                <div class="col-md-2">
                                                    <img width="100%" src="{{URL::asset('/uploads/client/customer/'.$get_customer_img->khachhang_anh)}}" class="img img-responsive img-thumbnail">
                                                </div>
                                            @endif
                                            <div class="col-md-10">
                                                <p>
                                            ...
                                            @foreach ($comment_reply as $key =>$comment_rep)
                                                @if($comment_rep->admin_id > 0)
                                                    <div class="row style_comment" style="margin:5px 40px;background: aquamarine;">
                                                        <div class="col-md-2">
                                                            <img width="70%" src="{{URL::asset('/backend/images/users/SHOES.png')}}" class="img img-responsive img-thumbnail">
                                                        </div>
                                                        <div class="col-md-8">
                                                ...
                                                @else
                                                    <div class="row style_comment">
                                                        <div class="col-md-2">
                                                            <img width="70%" src="{{URL::asset('/backend/images/users/batman-icon.png')}}" class="img img-responsive img-thumbnail">
                                                        </div>
                                                        <div class="col-md-10">
                                                            <p style="color:green;">{{ $comment->binhluan_ten_nguoi_danh_gia }}</p>
                                                            <p style="color:#000;">{{ $comment->binhluan_ngay_danh_gia }}</p>
