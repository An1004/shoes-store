            ...
            <!-- content -->
                        ...
                        <div class="card-box">
                            <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" cellspacing="0" id="tickets-table">
                                ...
                                <tr>
                                    ...
                                    <th class="font-weight-medium">Tên Loại</th>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="javascript: void(0);">
                                                <img src="{{asset('/uploads/admin/producttype/'.$pro_type->loaisanpham_anh)}}" alt="contact-img" title="contact-img" class="avatar-lg rounded-circle img-thumbnail">
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{URL::to('/product-type-edit/'.$pro_type->id)}}"><i class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Cập Nhật</a>
                                                    <a class="dropdown-item" href="{{URL::to('/delete-product-type/'.$pro_type->id)}}" onclick="return confirm('Xóa loại sản phẩm?')"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i>Xóa</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <nav>
                    <ul class="pagination pagination-rounded mb-3">
                        {{ $all_product_type->links('layout.paginationlinks') }}
                    </ul>
                </nav>
            <!-- end content -->
            <!-- end page title -->
