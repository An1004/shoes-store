                                    ...
                                    <form action="{{ URL::to('product-type-save-edit/'.$product_type->id) }}" enctype="multipart/form-data" class="form-horizontal" role="form"  method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            {{--  <div class="col-sm-10">
                                                ...
                                                <img width="100px" height="100px" id="image" src="{{asset('/uploads/admin/producttype/'.$product_type->loaisanpham_anh)}}" />
                                            </div>  --}}
                                            <div class="col-sm-10">
                                                ...
                                                <img class=" mt-3" width="100px" height="100px" id="image" src="{{asset('/uploads/admin/producttype/'.$product_type->loaisanpham_anh)}}" />
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="form-group row">
