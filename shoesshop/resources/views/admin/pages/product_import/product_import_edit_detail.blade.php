                                       ...
                                       @csrf
                                        <div class="form-group row">
                                            <div class="col-sm-4 img-product-import-select">
                                                <img class=" mt-3" width="300px" height="300px" id="image" src="{{ asset('/uploads/admin/product/'.$product_import_detail->Product->sanpham_anh) }}" />
                                            </div>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            {{-- <div class="col-sm-12">
                                                ...
                                                <input type="text" min="1" name="product_import_detail_price_sale" value="{{number_format($product_in_stock->sanphamtonkho_gia_ban,0,',','.' ) }}" required="" class="form-control" >
                                                <input type="hidden" min="1" name="product_import_detail_price_sale_old" value="{{ $product_in_stock->sanphamtonkho_gia_ban }}" required="" class="form-control" >
                                            </div> --}}
