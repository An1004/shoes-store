            ...
            <div class="row">
                    <div class="col-lg-4 col-xl-4">
                        <div class="card-box text-center">
                            <img src="{{asset('/uploads/client/customer/'.$customer->khachhang_anh)}}" class="rounded-circle avatar-xl img-thumbnail" alt="profile-image">
                            ...
                            <div class="text-left mt-3">
                                ...
                                <p class="text-muted mb-1 font-13"><strong>Giới Tính :</strong>
                                     {{-- <span class="ml-2">
                                        ...
                                        @endif --}}
                                        @if($customer->khachhang_gioi_tinh==1)
                                        Nam
                                        @else
                                            @if ($customer->khachhang_gioi_tinh==0)
                                                Nữ
                                            @else
                                                Chưa cập nhập
                                            @endif
                                ...
                                <p class="text-muted mb-1 font-13"><strong>Địa Chỉ :</strong> <span class="ml-2">{{ $address->diachi_ten }}</span></p>
                            </div>
                        </div> <!-- end card-box -->
                    </div> <!-- end col-->
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if ($customer->khachhang_gioi_tinh==0 || $customer->khachhang_gioi_tinh!=1)
                                                        <div class="custom-control custom-radio">
                                                            <input class=" custom-control-input" type="radio" name="staff_gender" value="0" id="male" checked>
                                                            <label class=" custom-control-label" for="male">Nữ</label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <input class=" custom-control-input" type="radio" name="staff_gender" value="1" id="female" >
                                                            <label class="custom-control-label" for="female">Nam</label>
                                                        </div>
                                                    @else
                                                        <div class="custom-control custom-radio">
                                                            <input class=" custom-control-input" type="radio" name="staff_gender" value="0" id="male" >
                                                            <label class=" custom-control-label" for="male">Nữ</label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <input class=" custom-control-input" type="radio" name="staff_gender" value="1" id="female" checked>
                                                            <label class="custom-control-label" for="female">Nam</label>
                                                        </div>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" readonly class="form-control" value="{{ $address->diachi_ten }}" required="">
                                                </div>
                                            </div><!-- end col -->
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{--  <div class="col-sm-10">
                                                        ...
                                                        <img width="100px" height="100px" id="image" src="{{asset('/uploads/admin/staff/'.$staff->admin_anh)}}"/>
                                                    </div>  --}}
                                                    <div class="col-sm-10">
                                                        <label class="col-form-label mt-3 mr-3" >Ảnh</label>
                                                        <img class=" mt-3" width="100px" height="100px" id="image" src="{{asset('/uploads/client/customer/'.$customer->khachhang_anh)}}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
