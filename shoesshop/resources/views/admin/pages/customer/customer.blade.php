                                ...
                                <tbody class="font-14">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if($customer->khachhang_anh)
                                            <a href="javascript: void(0);">
                                                <img src="{{asset('/uploads/client/customer/'.$customer->khachhang_anh)}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                            </a>
                                            @else
                                            <a href="javascript: void(0);">
                                                <img src="{{URL::asset('/uploads/client/customer/batman-icon82.png')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                            </a>
                                            @endif
                                        </td>
                                        <td>
