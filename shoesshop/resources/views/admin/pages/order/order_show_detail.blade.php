                                        ...
                                        <div class="col-sm-12">
                                         @if(isset($order_admin)!=NULL)
                                            <label class="col-form-label"> 
                                                 <p>NHÂN VIÊN XÁC NHẬN: {{$order_admin->admin_ho.' '.$order_admin->admin_ten}} </p>
                                            </label>
                                        @endif
                                         ...
                                         <br>
                                                <label class="col-form-label"> 
                                                    <p> Ngày xác nhận:  {{$order->ngay_xuly}}  </p>
                                                </label> 
                                          @endif
                                        </div>
                                    </div>
                                                    ...
                                                    <table class="table table-hover  mb-0">
                                                        ...
                                                        <tbody>
                                                             <tr style="background-color: #faffd5; color:#43b103; font-weight:bold">
                                                                ...
                                                                <td>
                                                                    @if($order_delivery->giaohang_trang_thai==0)
                                                                    Chưa giao hàng
                                                                    @elseif($order_delivery->giaohang_trang_thai==1)
                                                                    Đã lấy hàng
                                                                    @elseif($order_delivery->giaohang_trang_thai==2)
                                                                    Đã giao hàng
                                                                    @endif    
                                                                </td>
                                                                <!-- <td>
