                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <div class="text-lg-right mt-3 mt-lg-0">
                                <a href="{{URL::to('/delivery')}}" class="btn btn-success waves-effect waves-light"><i class="ti-arrow-left mr-1"></i>Quay Lại Giao Hàng</a>
                            </div>
                        </div>
                                ...
                                <div class="p-2">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label class="col-form-label">Trạng Thái Đơn Hàng</label>
                                                            ...
                                                            @elseif($order->dondathang_tinh_trang_thanh_toan==4 && $order->dondathang_trang_thai==1)
                                                                <input type="text" readonly value="Đã xác nhận, đã thanh toán PayPal" class="form-control"></input>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <div class="text-lg-left mt-3 mt-lg-0">
                                                            ...
                                                            @endif
                                                            @if($order_delivery->giaohang_trang_thai!=2 && $order->dondathang_trang_thai==1)
                                                            <a href="{{URL::to('/order-in-transit/'.$order->id)}}"  class="btn btn-success waves-effect" onclick="return confirm('Xác nhận lấy hàng?')"><i class="mdi mdi-content-save mr-2"></i>Xác Nhận Đã Lấy Hàng</a>
                                                            @endif
                                                            @if($order_delivery->giaohang_trang_thai==1 && $order->dondathang_trang_thai==2 && $order->dondathang_trang_thai!=3 && $order->dondathang_trang_thai!=4 && $order->dondathang_trang_thai!=0)
                                                            <a href="{{URL::to('/order-confirm-delivery/'.$order->id)}}"  class="btn btn-success waves-effect" onclick="return confirm('Xác nhận giao hàng?')"><i class="mdi mdi-content-save mr-2"></i>Xác Nhận Giao Hàng</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                        <div class="col-sm-12">
                                         @if(isset($delivery_admin)!=NULL)
                                            <label class="col-form-label"> 
                                                 <p>NHÂN VIÊN XÁC NHẬN LẤY HÀNG: {{$delivery_admin->admin_ho.' '.$delivery_admin->admin_ten}} </p>
                                            </label>
                                        @endif
                                        
                                         @if(isset($order->ngay_xuly)!=NULL)
                                         <br>
                                                <label class="col-form-label"> 
                                                    <p> Ngày giao hàng:  {{$order_delivery->giaohang_ngay_giao}}  </p>
                                                </label> 
                                          @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                         <!-- @if(isset($order_admin)!=NULL)
                                            <label class="col-form-label"> 
                                                 <p>NHÂN VIÊN XÁC NHẬN GIAO HÀNG: {{$order_admin->admin_ho.' '.$order_admin->admin_ten}} </p>
                                            </label>
                                        @endif -->
<!--                                         
                                        @if(isset($order_delivery->giaohang_ngaygiao)!=NULL)
                                         <br>
                                                <label class="col-form-label"> 
                                                    <p> Ngày giao: {{$order_delivery->giaohang_ngaygiao}} </p>
                                                </label> 
                                          @endif
                                        </div> -->
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <label class="col-form-label"> <h4>Khách Hàng</h4></label>
                                                    <div class="table-responsive" id="ajax-queue">
                                                        <table class="table table-hover  mb-0">
                                                            <thead>
                                                            <tr style="background-color: #BCE29E; color:black; font-weight:bold">
                                                                <td>Ảnh</td>
                                                                <td>Tên User</td>
                                                                <td>Tên</td>
                                                                <td>Số Điện Thoại</td>
                                                            ...
                                                            <tbody>
                                                                @if(isset($order_customer))
                                                                    <tr style="background-color: #f2f7cd; color:#eb663e; font-weight:bold">
                                                                        <td>
                                                                            <a href="javascript: void(0);">
                                                                                <img src="{{asset('/uploads/client/customer/'.$order_customer->khachhang_anh)}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                                                            </a>
                                                                        </td>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive" id="ajax-queue">
                                                        <table class="table table-hover  mb-0">
                                                            ...
                                                            <tbody >
                                                                <tr style="background-color: #f8f5f5; color:#FF8787; font-weight:bold">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @elseif ($order->dondathang_tinh_trang_thanh_toan==1)
                                                                            Đã thanh toán
                                                                        @elseif ($order->dondathang_tinh_trang_thanh_toan==4)
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="table-responsive" id="ajax-queue">
                                                    <table class="table table-hover  mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr style="background-color: #faffd5; color:#43b103; font-weight:bold">
                                                                ...
                                                                <td>{{$order_delivery->giaohang_phuong_thuc_thanh_toan?'Đã thanh toán':'Thanh toán khi nhận hàng' }}</td>
                                                                <td>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <label class="col-form-label" style="color: black">Sản Phẩm</label>
                                                <div class="table-responsive" id="ajax-queue">
                                                    <table class="table table-hover  mb-0">
                                                        <thead>
                                                        <tr style="background-color: #c8fffa; color:black; font-weight:bold">
                                                            <td>Ảnh</td>
                                                            <td>Sản Phẩm</td>
                                                            <td>Số Lượng</td>
                                                            <td>Giá</td>
