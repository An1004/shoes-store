                    ...
                    <div class="col-lg-4 col-xl-4">
                        <div class="card-box text-center">
                            ...
                            @if($staff->admin_anh)
                                            ...
                                            @else
                                            <a href="javascript: void(0);">
                                                <img src="{{URL::asset('/backend/images/users/businessman.jpg')}}" class="rounded-circle avatar-xl img-thumbnail" alt="profile-image">
                                            </a>
                                            @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @if ($staff->admin_gioi_tinh==1 || $staff->admin_gioi_tinh!=0)
                                                    ...
                                                    @else
                                                        @if ($staff->admin_gioi_tinh==0 || $staff->admin_gioi_tinh!=1)
                                                        <div class="custom-control custom-radio">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <img class=" mt-3" width="100px" height="100px" id="image" src="{{asset('/uploads/admin/staff/'.$staff->admin_anh)}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
