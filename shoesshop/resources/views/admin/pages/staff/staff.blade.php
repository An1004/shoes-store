                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="javascript: void(0);">
                                                <img src="{{asset('/uploads/admin/staff/'.$staff->admin_anh)}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                            </a>
                                            @else
                                            <a href="javascript: void(0);">
                                                <img src="{{URL::asset('/backend/images/users/businessman.jpg')}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                            </a>
                                            @endif
                                        ...
                                        <td>
                                            @if($staff->admin_gioi_tinh==0)
                                            Nữ
                                        @else
                                            @if ($staff->admin_gioi_tinh==1)
                                                Nam
                                            @else
                                                Chưa cập nhập
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            @elseif($staff->UserAccount->loainguoidung_id==3)
                                                Nhân viên giao hàng
                                            @elseif($staff->UserAccount->loainguoidung_id==5)
                                                Nhân viên tin tức
                                            @elseif($staff->UserAccount->loainguoidung_id==8)
                                                Nhân viên QL đơn hàng
                                            @endif
                                        </td>
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="{{URL::to('/staff-my-account-change-email/'.$staff->user_id)}}"><i class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Đổi Email Nhân Viên</a>
                                                    {{-- <a class="dropdown-item" href="{{URL::to('/staff-my-account-change-password/'.$staff->user_id)}}"><i class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Đổi Mật Khẩu Nhân Viên</a> --}}
