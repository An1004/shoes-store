        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb page-title">
                            ...
                            <li class="breadcrumb-item active">Đổi Email Tài Khoản</li>
                        </ol>
                    </div>
                </div>
            </div>
            <!-- content -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="header-title">Đổi Email</h4>
                            <p class="sub-header">
                            <hr>
                            ...
                            <form action="{{URL::to('/staff-my-account-change-email-save')}}" class="parsley-form" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="pass1" name="staff_email" type="email" placeholder="Email" required="" class="form-control" value="{{$user_staff->user_email}}" readonly >
                                    @error('staff_email')
