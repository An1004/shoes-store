                            ...
                            <tbody class="font-14 load-transport-fee">
                                ...
                                <tr>
                                    ...
                                    <td>
                                                    ...
                                                    <a class="dropdown-item" href="{{URL::to('/delete-fee/'.$value->id)}}" onclick="return confirm('Bạn muốn xóa?')"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i></a> 
