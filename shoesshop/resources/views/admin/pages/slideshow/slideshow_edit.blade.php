                                           ...
                                           {{ csrf_field() }}
                                            ...
                                            <div class="form-group row">
                                                ...
                                                {{--  <div class="col-sm-10">
                                                    ...
                                                    <img width="100px" height="100px" id="image" src="{{asset('/uploads/admin/slideshow/'.$slideshow->slidequangcao_anh)}}" />
                                                </div>  --}}
                                                <div class="col-sm-10">
                                                    ...
                                                    <img class=" mt-3" width="100px" height="100px" id="image" src="{{asset('/uploads/admin/slideshow/'.$slideshow->slidequangcao_anh)}}" />
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group row">
