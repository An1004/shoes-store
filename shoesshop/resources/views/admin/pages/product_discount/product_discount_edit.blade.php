                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <img class=" mt-3" width="100px" height="100px" id="image" src="{{asset('/uploads/admin/productdiscount/'.$discount->khuyenmai_anh)}}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="javascript: void(0);">
                                                                                    <img src="{{asset('/uploads/admin/product/'.$product->Product->sanpham_anh)}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                                                                </a>
                                                                            </td>
