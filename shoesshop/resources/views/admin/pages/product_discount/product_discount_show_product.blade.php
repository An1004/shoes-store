                                    ...
                                    <tr>
                                        <td>
                                            <a href="javascript: void(0);">
                                                <img src="{{asset('/uploads/admin/productdiscount/'.$product_discount->khuyenmai_anh)}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                            </a>
                                        </td>
                                        <td>
                                ...
                                <tbody class="font-14">
                                        @foreach ($all_product as $k =>$value)
                                                <tr>
                                                    <td>
                                                        <a href="javascript: void(0);">
                                                            <img src="{{asset('/uploads/admin/product/'.$value->sanpham_anh)}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                                        </a>
                                                    </td>
                                                    <td>
                                                        {{ $value->sanpham_ten}}
