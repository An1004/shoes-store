            ...
            <!-- content -->
                                    ...
                                    <tr>
                                        <td>
                                            <a href="javascript: void(0);">
                                                <img src="{{asset('/uploads/admin/productnews/'.$product_news->baiviet_anh)}}" alt="contact-img" title="contact-img" class="rounded-circle avatar-lg img-thumbnail">
                                            </a>
                                        </td>
                                        <td>
                ...
                <nav>
                    <ul class="pagination pagination-rounded mb-3">
                        {{ $all_product_news->links('layout.paginationlinks') }}
                    </ul>
                </nav>
            <!-- end content -->
            <!-- end page title -->
