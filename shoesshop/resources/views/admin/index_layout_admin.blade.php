...
<body>
    ...
    <script type="text/javascript">
        CKEDITOR.replace('product_news_content');
    </script>
        ...
        $('.add-queue').click(function(){
            ...
            var _token = $('input[name="_token"]').val();
             $.ajax({
                 ...
                 method: 'POST',
                 data:{product_id:product_id,product_name:product_name,product_image:product_image,product_size:product_size,product_size_id:product_size_id,_token:_token},
                 success:function(data){
                    Swal.fire({
                        title: "Add Success",
                        type: "success",
...
<script>
    ...
    $('.product_role').on('change',function(){
        var role_id = $(this).data('id_role');
        var product_role = $('.product_role_'+ role_id).val();   
        // alert(role_id)
        $.ajax({
            url : '{{url("/role-edit")}}',
            method: 'GET',
            data:{role_id:role_id,product_role:product_role,import_product_role:'',order_role:'',staff_role:'',news_role:'',shipping_role:'',statistics_role:''},
            success:function(data){
                Swal.fire({
    ...
    $('.import_product_role').on('change',function(){
        var role_id = $(this).data('id_role');
        var import_product_role = $('.import_product_role_'+ role_id).val();
      
        $.ajax({
            url : '{{url("/role-edit")}}',
            method: 'GET',
            data:{role_id:role_id,product_role:'',import_product_role:import_product_role,order_role:'',staff_role:'',news_role:'',shipping_role:'',statistics_role:''},
            success:function(data){
                Swal.fire({
                        title: "Cập nhập thành công",
                        type: "success",
    ...
    $('.order_role').on('change',function(){
        var role_id = $(this).data('id_role');
        var order_role = $('.order_role_'+ role_id).val();
        // alert(role_id)
        $.ajax({
            url : '{{url("/role-edit")}}',
            method: 'GET',
            data:{role_id:role_id,product_role:'',import_product_role:'',order_role:order_role,staff_role:'',news_role:'',shipping_role:'',statistics_role:''},
            success:function(data){
                Swal.fire({
                        title: "Cập nhập thành công",
                        type: "success",
    ...
    $('.staff_role').on('change',function(){
        ...
        var staff_role = $('.staff_role_'+ role_id).val();
      
        $.ajax({
            url : '{{url("/role-edit")}}',
            method: 'GET',
            data:{role_id:role_id,product_role:'',import_product_role:'',order_role:'',staff_role:staff_role,news_role:'',shipping_role:'',statistics_role:''},
            success:function(data){
                Swal.fire({
                        title: "Cập nhập thành công",
                        type: "success",
    ...
    $('.news_role').on('change',function(){
        var role_id = $(this).data('id_role');
        
        var news_role = $('.news_role_'+ role_id).val();
        
        $.ajax({
            url : '{{url("/role-edit")}}',
            method: 'GET',
            data:{role_id:role_id,product_role:'',import_product_role:'',order_role:'',staff_role:'',news_role:news_role,shipping_role:'',statistics_role:''},
            success:function(data){
                Swal.fire({
                        title: "Cập nhập thành công",
                        type: "success",
    ...
    $('.shipping_role').on('change',function(){
        var role_id = $(this).data('id_role'); 
        var shipping_role = $('.shipping_role_' + role_id).val();
       
        $.ajax({
            url : '{{url("/role-edit")}}',
            method: 'GET',
            data:{role_id:role_id,product_role:'',import_product_role:'',order_role:'',staff_role:'',news_role:'', shipping_role: shipping_role,statistics_role:''},
            success:function(data){
                Swal.fire({
                        title: "Cập nhập thành công",
                        type: "success",
    ...
    $('.statistics_role').on('change',function(){
        var role_id = $(this).data('id_role'); 
        var statistics_role = $('.statistics_role_' + role_id).val();
       
        $.ajax({
            url : '{{url("/role-edit")}}',
            method: 'GET',
            data:{role_id:role_id,product_role:'',import_product_role:'',order_role:'',staff_role:'',news_role:'', shipping_role: '',statistics_role: statistics_role},
            success:function(data){
                Swal.fire({
                        title: "Cập nhập thành công",
                        type: "success",
