...
Route::get('/login-google','CustomerController@LoginGoogle');
Route::get('/login-google/callback','CustomerController@CallBackGoogle');
...
Route::get('/change-price', 'HomeController@ChangePrice');
Route::get('/change-price-hidden', 'HomeController@ChangePriceHidden');
Route::get('/change-instock-product', 'HomeController@ChangeProductInStock');
Route::get('/get-product-image', 'HomeController@GetProductImage');
//Order Tracking
...
Route::get('/change-feeships', 'CheckoutController@ChangeFeeships');
Route::get('/change-feeship1', 'CheckoutController@ChangeFeeship1');
...
Route::get('/customer-address/{customer_id}', 'CustomerController@ShowAddress');
Route::get('/customer-address-choose/{address_id}', 'CustomerController@AddressChoose');
Route::get('/customer-address-add', 'CustomerController@TransportFee');
Route::post('/customer-address-save/{customer_id}', 'CustomerController@AddressAdd');
Route::post('/customer-address-save-edit/{address_id}', 'CustomerController@AddressEditSave');
Route::get('/customer-address-edit/{address_id}', 'CustomerController@AddressEdit');
Route::get('//address-customer-delete/{address_id}', 'CustomerController@AddressDelete');
...
//Blog
Route::get('/blog-detail/{blog_id}', 'HomeController@ShowBlog');
...
Route::get('/staff-delete/{staff_id}', 'AdminHomeController@StaffDelete');
...
Route::get('/staff-my-account-change-email/{staff_id}', 'AdminHomeController@ShowStaffChangeEmail');
...
//permission
Route::get('/role', 'AdminHomeController@Role');
Route::get('/role-edit', 'AdminHomeController@RoleEdit');
Route::get('/role-delete', 'AdminHomeController@RoleDelete');
Route::post('/role-add-save', 'AdminHomeController@RoleAddSave');
...
Route::get('/product-price-size/{product_id}', 'ProductController@ProductPriceSize');
Route::post('/product-size-price-save/{product_id}', 'ProductController@PriceSizeSave');
Route::get('/product-price-save/{product_id}', 'ProductController@ProductPriceSizeSave');
Route::get('/price-size-delete/{price_id}', 'ProductController@DeletetPriceSize');
...
Route::get('/delete-fee/{id}', 'TransportFeeController@TransportFeeDelete');
...
Route::get('/search-order-statistics-chart', 'StatisticsController@SearchOrderStatisticsChart');
Route::get('/search-select-order-statistics', 'StatisticsController@SearchSelectOrderStatistics');
Route::get('/search-select-order-statistics-chart', 'StatisticsController@SearchSelectOrderStatisticsChart');
